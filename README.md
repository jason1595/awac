...
## Features
Tailored for Direct TTYs: Designed to render on small hardware displays and standard virtual consoles without relying on xterm features or desktop server environments.
